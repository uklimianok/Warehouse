...
(nextval('position_seq'), 'Truck Driver', 'TRUCK_DRIVER'),
(nextval('position_seq'), 'Goods Unloader', 'GOODS_UNLOADER'),
(nextval('position_seq'), 'Goods Picker', 'GOODS_PICKER'),
(nextval('position_seq'), 'Set Goods Exporter', 'SET_GOODS_EXPORTER'),
(nextval('position_seq'), 'Set Goods Loader', 'SET_GOODS_LOADER'),
(nextval('position_seq'), 'Operator', 'OPERATOR'),
(nextval('position_seq'), 'Return Goods Controller', 'RETURN_GOODS_CONTROLLER'),
(nextval('position_seq'), 'Coordinator', 'COORDINATOR'),
(nextval('position_seq'), 'Data Controller', 'DATA_CONTROLLER'),
(nextval('position_seq'), 'Shift Supervisor', 'SHIFT_SUPERVISOR'),
(nextval('position_seq'), 'Mechanic', 'MECHANIC'),
(nextval('position_seq'), 'Director', 'DIRECTOR'),
(nextval('position_seq'), 'Major HR', 'MAJOR_HR'),
(nextval('position_seq'), 'Warehouse Employees HR', 'WAREHOUSE_EMPLOYEES_HR'),
(nextval('position_seq'), 'Office Employees HR', 'OFFICE_EMPLOYEES_HR'),
(nextval('position_seq'), 'Cleaner', 'CLEANER'),
(nextval('position_seq'), 'Electric', 'ELECTRIC'),
(nextval('position_seq'), 'General Laborer', 'GENERAL_LABORER'),
(nextval('position_seq'), 'Orders Proceeder', 'ORDERS_PROCEEDER'),
(nextval('position_seq'), 'Statistics Proceeder', 'STATISTICS_PROCEEDER'),
(nextval('position_seq'), 'Major Accountant', 'MAJOR_ACCOUNTANT'),
(nextval('position_seq'), 'Accountant', 'ACCOUNTANT'),
(nextval('position_seq'), 'Developer', 'DEVELOPER'),
(nextval('position_seq'), 'System Administrator', 'SYSTEM_ADMINISTRATOR'),
(nextval('position_seq'), 'Labor Protector', 'LABOR_PROTECTOR');
...
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 7, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 8, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 9, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 10, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 11, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 12, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 13, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 14, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 15, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 16, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 17, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 18, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 19, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 20, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 21, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 22, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 23, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895'),
(nextval('employee_seq'), 'FirstName', 'LastName', 1, '06000001', 24, 1, '1990-01-01', '123456789', 'Address 06', '+1234567895');
